...
import { SessionStore, WorkspaceExistsError, SessionNotFoundError, } from './session-store.js';
describe('SessionStore', () => {
    ...
    describe('get', () => {
        ...
        it('throws SessionNotFoundError for non-existent ID', async () => {
            await expect(store.get('non-existent-id')).rejects.toThrow(SessionNotFoundError);
        });
    });
    describe('update', () => {
        ...
        it('throws SessionNotFoundError for non-existent ID', async () => {
            await expect(store.update('non-existent-id', { title: 'Test' })).rejects.toThrow(SessionNotFoundError);
        });
    });
    describe('delete', () => {
        ...
        it('throws SessionNotFoundError for non-existent ID', async () => {
            await expect(store.delete('non-existent-id')).rejects.toThrow(SessionNotFoundError);
        });
    });
});
