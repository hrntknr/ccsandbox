...
import type { ClaudePendingPermission, AskUserQuestion, ClaudePermissionMode } from '@shared/index.js';

interface AskUserQuestionDialogProps {
  permission: ClaudePendingPermission;
  questions: AskUserQuestion[];
  onResponse: (requestId: string, permission: 'allow' | 'deny', answers?: Record<string, string>, permissionMode?: ClaudePermissionMode) => void;
}
